...
@section('main')
    <section class="w-full column g-10">
       <div class="pos-relative">
        <div onclick="Redirect('{{ url()->previous() == url()->current() ? url('users/dashboard') : url()->previous() }}')" style="background:var(--rgt-07);color:var(--rgb-10);top:10px;left:10px;backdrop-filter:blur(10px);-webkit-backdrop-filter:blur(10px);" class="h-40 pos-absolute w-40 circle column align-center justify-center">
