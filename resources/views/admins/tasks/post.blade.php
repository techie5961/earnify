...
@section('main')
    <section class="w-full column g-10">
         <form style="border:1px solid var(--rgt-01);" action="{{ url('admins/post/task/process') }}" onsubmit="PostRequest(event,this,Posted)" class="w-full bg-light br-10 p-20 column g-10">
            ...
            <div class="column g-5 w-full">
                ...
                <small>Enter display title of the task</small>
                 <div class="cont">
               <input placeholder="Enter Task Title ( E.g Whatsapp Group)" type="text" class="inp input required" name="title">
            </div>
            </div>
             {{-- new input --}}
            <div class="column g-5 w-full">
            ...
            <div class="column g-5 w-full">
                ...
                <small>How much each user earns when he/she performs this task</small>
                 <div class="cont">
               <input placeholder="Enter Task Reward" type="number" inputmode="numeric" class="inp input required" name="reward">
            </div>
            </div>
                  {{-- new input --}}
            <div class="column g-5 w-full">
                ...
                <small>The task is automatically removed from users dashboard if the members limit is reached( <span class="font-weight-900">For Example, For a 100 members task,the task is automatically removed when 100 users have performed  the task</span> ),you don't need to manually delete it</small>
                 <div class="cont">
               <input name="members" inputmode="numeric" type="number" placeholder="I.e 100 members" class="inp input required">
                 </div>
                 </div>
                   {{-- new input --}}
            <div class="column g-5 w-full">
                <label>Banner(Optional)</label>
                 <label class="column g-5px w-full h-150px border-width-1px border-style-solid border-color-rgt-01 p-20px align-center justify-center text-center">
                    <span class="opacity-05">Tap to upload Banner( Optional )</span>
