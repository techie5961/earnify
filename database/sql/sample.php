...
// withdrawal
    ...
    // 'type' => 'withdrawal',
    // 'amount' => 6000,
    // 'wallet' => {"key":"main_balance","name":"Weekly Allowance","class":"general"},
    // 'json' => json_encode([
    // 'balance' => [
    //     'before' => 10000,
    //     'after' => 4000
    // ],
    // {"balance":{"before":19000,"after":18600},
    // "primary_wallet":"Main Wallet",
    // "bank":{"method":"bank","account_number":"5006864688","bank_name":"Above Only MFB","account_name":"David James"}}]) (json column end)
     // data => json_encode([
    // add data json here(note no nested json direct)
    // ]),
    // 'status' => 'rejected',
