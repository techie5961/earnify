...
Route::get('earners/top',[
    UserDashboardController::class,'TopEarners'
]);
// vendors
Route::get('vendors',[
    UserDashboardController::class,'Vendors'
]);
// coupon checker
Route::get('coupon/checker',[
    UserDashboardController::class,'CouponChecker'
]);
...
Route::middleware([UsersDashboardMiddleware::class])->group(function(){
    ...
    // vendors dashboard
  Route::get('users/vendors/dashboard',[
    UserDashboardController::class,'VendorsDashboard'
  ]);
    // payout settings
    ...
    // transaction pin
    Route::get('users/transaction/pin',[
        UserDashboardController::class,'TransactionPin'
    ]);
    // google to earn
    Route::get('users/google/to/earn',[
        UserDashboardController::class,'GoogleToEarn'
    ]);
    // games
    Route::get('users/games',[
        UserDashboardController::class,'Games'
    ]);
    // cube game
    Route::get('users/cube/game',[
        UserDashboardController::class,'CubeGame'
    ]);
    ...
    // complete task
    Route::post('users/post/claim/task/reward/process',[
    UsersPostRequestController::class,'ClaimTaskReward'
    ]);
    // withdrawal
    ...
    Route::post('users/post/update/transaction/pin/process',[
        UsersPostRequestController::class,'UpdateTransactionPin'
    ]);
    // update profile
    Route::post('users/post/profile/updated/process',[
        UsersPostRequestController::class,'UpdateProfile'
    ]);
    // google to earn 
    Route::post('users/post/reward/google/to/earn/process',[
        UsersPostRequestController::class,'GoogleToEarn'
    ]);
    // redeem voucher 
...
Route::post('users/post/login/process',[
 ...
 // send code
    ...
    Route::post('users/post/forgot/password/set/new/password/process',[
     ...
     // coupon checker
    Route::post('users/post/check/coupon/code/process',[
        UsersPostRequestController::class,'CouponChecker'
    ]);
...
// packages list
Route::get('admins/packages/list',[
    AdminsDashboardController::class,'PackagesList'
]);
// create coupon code
Route::get('admins/coupon/code/create',[
    AdminsDashboardController::class,'CreateCouponCode'
]);
// manage coupon codes
Route::get('admins/coupon/codes/manage',[
    AdminsDashboardController::class,'ManageCouponCodes'
]);
// delete coupon code
Route::get('admins/coupon/code/delete',[
    AdminsDashboardController::class,'DeleteCoupon'
]);
// mark as vendor
Route::get('admins/mark/as/vendor',[
    AdminsDashboardController::class,'MarkAsVendor'
]);
// withdrawal portal
Route::get('admins/withdrawal/portal',[
    AdminsDashboardController::class,'WithdrawalPortal'
]);
// create voucher
Route::get('admins/voucher/create',[
    AdminsDashboardController::class,'CreateVoucher'
]);
// manage vouchers
Route::get('admins/vouchers/manage',[
    AdminsDashboardController::class,'ManageVouchers'
]);
// delete voucher
Route::get('admins/get/voucher/delete',[
    AdminsDashboardController::class,'DeleteVoucher'
]);
// edit voucher 
...
// create coupon code
Route::post('admins/post/create/coupon/code/process',[
    AdminsPostRequestController::class,'CreateCouponCode'
]);
// withdrawal portal
Route::post('admins/post/withrawal/portal/process',[
    AdminsPostRequestController::class,'WithdrawalPortal'
]);
// create voucher 
Route::post('admins/post/create/voucher/process',[
    AdminsPostRequestController::class,'CreateVoucher'
]);
// edit voucher
Route::post('admins/post/edit/voucher/process',[
    AdminsPostRequestController::class,'EditVoucher'
]);
