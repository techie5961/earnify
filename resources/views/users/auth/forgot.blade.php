...
@section('main')
    <div class="form">
            ...
            {{-- desc --}}
            <strong class="font-size-1-5 font-weight-900">Forgot <br> Password?</strong>
         {{-- text --}}
            <span class="opacity-07">No worries &mdash; we will help you get back to your account.</span>
            {{-- steps --}}
            <div class="steps">
                {{-- new step --}}
       ...
       <input type="hidden" name="_token" value="{{ @csrf_token() }}" class="inp input">
        ...
        <div class="column g-5 w-full">
            ...
            <div class="cont w-full">
                 <input name="email"   placeholder="Enter your registered email" type="email" class="inp input required">
            </div>
        ...
        <span onclick="Vitecss.navigate('{{ url('users/login') }}')" class="c-secondary row align-center g-5 no-select pointer">
       ...
       <input type="hidden" class="inp input" name="email">
                ...
                {{-- prompt --}}
                <div style="border:1px solid #4caf50;padding:15px;background:rgba(0,255,0,0.1);max-width:250px;" class="w-fit column br-10 align-center justify-center g-10">
<svg viewBox="0 0 24 24" fill="#4caf50" xmlns="http://www.w3.org/2000/svg" height="40" width="40"><path d="M22 13.3414C21.3744 13.1203 20.7013 13 20 13C16.6863 13 14 15.6863 14 19C14 19.7013 14.1203 20.3744 14.3414 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3H21C21.5523 3 22 3.44772 22 4V13.3414ZM12.0606 11.6829L5.64722 6.2377L4.35278 7.7623L12.0731 14.3171L19.6544 7.75616L18.3456 6.24384L12.0606 11.6829ZM19 22L15.4645 18.4645L16.8787 17.0503L19 19.1716L22.5355 15.636L23.9497 17.0503L19 22Z"></path></svg>

                    <div style="max-width:100%;color:greenyellow;" class="text-center">
                     Verification code sent successfully <br> kindly check your spam folder if you cant find it
                   </div>
                </div>
        {{-- new input --}}
        <div class="column g-5 w-full">
            ...
            <div class="cont w-full">
                 <input name="code"   placeholder="Enter 6-digit code" type="number" class="inp input required">
            </div>
       ...
       <input type="hidden" class="inp input" name="otp">
        ...
        <div class="column g-5 w-full">
            ...
            <div class="cont w-full">
                 <input name="password"  placeholder="Enter new password" type="password" class="inp input required">
            </div>
        ...
        <div class="column g-5 w-full">
            ...
            <div class="cont w-full">
                 <input name="confirm"  placeholder="Confirm your new password" type="password" class="inp input required">
            </div>
