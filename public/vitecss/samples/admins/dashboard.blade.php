          ...
          <div class="card">
           <div class="row w-full space-between">
            <div class="column g-5">
                ...
                <span class="">Total Promoters</span>
             <span style="color:rgb(100,255,100);font-size:0.6rem;">&uarr; 12.5% Increase</span>
            </div>
          ...
          <div class="card">
           <div class="row w-full space-between">
            <div class="column g-5">
                ...
                <span class="">Pending Deposits</span>
             <span style="color:rgb(100,255,100);font-size:0.6rem;">&uarr; 12.5% Increase</span>
            </div>
        ...
        {{-- NEW CARD --}}
          <div class="card">
           <div class="row w-full space-between">
            <div class="column g-5">
                <strong class="desc">&#8358;120,000.00</strong>
                <span class="">Pending Withdrawals</span>
             <span style="color:rgb(100,255,100);font-size:0.6rem;">&uarr; 12.5% Increase</span>
            </div>
            <div style="background:rgba(255, 217, 0, 0.2)" class="p-10 h-fit w-fit br-10">
        ...
        {{-- NEW CARD --}}
          <div class="card">
           <div class="row w-full space-between">
            <div class="column g-5">
                <strong class="desc">&#8358;120,000.00</strong>
                <span class="">Successfull Deposits</span>
             <span style="color:rgb(100,255,100);font-size:0.6rem;">&uarr; 12.5% Increase</span>
            </div>
         ...
         {{-- NEW CARD --}}
          <div class="card">
           <div class="row w-full space-between">
            <div class="column g-5">
                <strong class="desc">&#8358;120,000.00</strong>
                <span class="">Successfull Withdrawals</span>
             <span style="color:rgb(100,255,100);font-size:0.6rem;">&uarr; 12.5% Increase</span>
            </div>
            <div style="background:rgba(0,255, 0, 0.2)" class="p-10 h-fit w-fit br-10">
         ...
         {{-- NEW CARD --}}
          <div class="card">
           <div class="row w-full space-between">
            <div class="column g-5">
                <strong class="desc">&#8358;120,000.00</strong>
                <span class="">Rejected Deposits</span>
             <span style="color:rgb(100,255,100);font-size:0.6rem;">&uarr; 12.5% Increase</span>
            </div>
         ...
         {{-- NEW CARD --}}
          <div class="card">
           <div class="row w-full space-between">
            <div class="column g-5">
                <strong class="desc">&#8358;120,000.00</strong>
                <span class="">Rejected Withdrawals</span>
             <span style="color:rgb(100,255,100);font-size:0.6rem;">&uarr; 12.5% Increase</span>
            </div>
            <div style="background:rgba(255,0, 0, 0.2)" class="p-10 h-fit w-fit br-10">
          ...
          <div class="card">
           <div class="row w-full space-between">
            <div class="column g-5">
                ...
                <span class="">Total Packages</span>
